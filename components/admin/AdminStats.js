...
import { ChevronDown, Users, Music, DollarSign, UserCheck } from "lucide-react";
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
        ...
        <div className="relative mt-2 sm:mt-0">
          <select
            ...
            className="appearance-none bg-gray-800 border border-gray-700 text-white rounded-lg px-4 py-2 pr-8 focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
